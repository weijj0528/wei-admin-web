...
export interface DictTypeDTO {
  id?: number; code?: string; name?: string; status?: number; remark?: string
  dataType?: string; validationRule?: string
}
...
export const getDictTypeByCode = (code: string) => request({ url: '/admin/dict/type/byCode', method: 'get', params: { code } })
// 字典列表
